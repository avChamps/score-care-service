              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
                <tr>
                  <td class="hero-title-col" width="75%" valign="middle" style="width:75%;vertical-align:middle;">
                    <div style="font-size:20px;line-height:26px;font-weight:700;color:#1B3A5C;">
                      Welcome to ScoreCare!
                    </div>
                    <div style="font-size:13px;line-height:20px;color:#1f9c80;margin-top:4px;">
                  ...
                  <td class="hero-score-col" width="25%" align="right" valign="middle" style="width:25%;text-align:right;vertical-align:middle;">
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="right">
                      <tr>
                        <td class="score-badge" align="center" valign="middle" style="width:76px;height:76px;background-color:#ffffff;border:3px solid #2EC4A0;border-radius:50%;text-align:center;vertical-align:middle;">
                          <div class="score-num" style="font-size:22px;line-height:24px;font-weight:700;color:#1B3A5C;">800+</div>
                          <div class="score-label" style="font-size:9px;line-height:12px;font-weight:700;color:#2EC4A0;text-transform:uppercase;letter-spacing:.5px;">Target</div>
                        </td>
                      </tr>
                    </table>
                  </td>
                      ...
                      <tr>
                        <td width="25%" style="padding:0 3px 0 0;">
                          <table class="score-range-card" role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#F09595;border-collapse:collapse;">
                            <tr>
                              <td align="center" style="padding:9px 2px;font-size:11px;line-height:15px;color:#501313;font-weight:700;">
                                300-549<br><span style="font-size:10px;color:#791F1F;font-weight:400;">Poor</span>
                              </td>
                            </tr>
                          </table>
                        </td>
                        ...
                        <td width="25%" style="padding:0 3px;">
                          <table class="score-range-card" role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#FAC775;border-collapse:collapse;">
                            <tr>
                              <td align="center" style="padding:9px 2px;font-size:11px;line-height:15px;color:#412402;font-weight:700;">
                                550-649<br><span style="font-size:10px;color:#633806;font-weight:400;">Fair</span>
                              </td>
                            </tr>
                          </table>
                        </td>
                        ...
                        <td width="25%" style="padding:0 3px;">
                          <table class="score-range-card" role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#a8dfc9;border-collapse:collapse;">
                            <tr>
                              <td align="center" style="padding:9px 2px;font-size:11px;line-height:15px;color:#0a3d29;font-weight:700;">
                                650-749<br><span style="font-size:10px;color:#155c3c;font-weight:400;">Good</span>
                              </td>
                            </tr>
                          </table>
                        </td>
                        ...
                        <td width="25%" style="padding:0 0 0 3px;">
                          <table class="score-range-card" role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#2EC4A0;border-collapse:collapse;">
                            <tr>
                              <td align="center" style="padding:9px 2px;font-size:11px;line-height:15px;color:#ffffff;font-weight:700;">
                                750-900<br><span style="font-size:10px;color:#e8fffa;font-weight:400;">Excellent</span>
                              </td>
                            </tr>
                          </table>
                        </td>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f7fafc;border:1px solid #e2ecf0;border-collapse:collapse;margin-bottom:10px;">
                <tr>
                  <td width="52" valign="top" style="width:52px;padding:14px 0 14px 14px;">
                    <span style="display:inline-block;background-color:#e0f5ef;color:#1B3A5C;font-size:11px;font-weight:700;line-height:34px;text-align:center;width:34px;height:34px;">REF</span>
                  </td>
              ...
              <table role="presentation" class="button-table" align="center" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:18px auto 24px;border-collapse:collapse;">
                <tr>
                  <td class="button-cell" width="50%" style="padding:0 5px 0 0;">
                    <a class="button-link" href="https://www.scorecareapp.com/dashboard" style="display:block;background-color:#2EC4A0;color:#ffffff;font-size:14px;line-height:18px;font-weight:700;text-decoration:none;padding:13px 10px;text-align:center;">
                      Check my score now
                    </a>
                  </td>
                  <td class="button-cell" width="50%" style="padding:0 0 0 5px;">
                    <a class="button-link" href="https://www.scorecareapp.com/report" style="display:block;background-color:#ffffff;color:#1B3A5C;font-size:14px;line-height:18px;font-weight:700;text-decoration:none;padding:12px 10px;border:1px solid #1B3A5C;text-align:center;">
                      View my report
                    </a>
                  </td>
                </tr>
